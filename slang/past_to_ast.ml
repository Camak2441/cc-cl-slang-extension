...
let rec translate_expr = function
    ...
    | Past.MultiLambda _       -> Errors.complain "internal error, translate found a MultiLambda that should have been resolved to a Lambda"
    ...
    *) 
    ...
    | Past.LetMultiFun _       -> Errors.complain "internal error, translate found a LetMultiFun that should have been resolved to a LetFun"
    ...
    | Past.Lazy(l, e) -> Ast.Lazy(l, translate_expr e)
    | Past.Strict(l, e) -> Ast.Strict(l, translate_expr e)
    | Past.StrictThunk(l, e) -> Ast.StrictThunk(l, translate_expr e)
